        ...
        <form id="addMonedaForm">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" minlength="2" maxlength="40" required value="" name="name" class="form-control" id="name"  placeholder="Nombre de la moneda">
              </div>
              <div class="form-group">
                <label for="symbol">Símbolo</label>
                <input type="text" minlength="1" maxlength="3" required value="" name="symbol" class="form-control" id="symbol" placeholder="Símbolo de la moneda">
              </div>
              <div class="form-group">
